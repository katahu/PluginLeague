...
if (prefersDarkScheme) {
  document.body.classList.add("bt-dark");
}

let currentLocation = null;
const sounds = {
  shine: chrome.runtime.getURL("audio/shine.mp3"),
  alert: chrome.runtime.getURL("audio/message.mp3"),
};
